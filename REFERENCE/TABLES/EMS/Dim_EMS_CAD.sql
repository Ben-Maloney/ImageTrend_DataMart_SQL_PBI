SELECT TOP (100)
      ...
      ,[CAD_CAD_ID] -- eg "RP25-9110820250813:09:01:27E19"
      ,[CAD_Agency_ID]
      ,[CAD_Incident_Number]
    ...
    --   ,[Incident_Incident_ID1_Internal] -- appears to all be NULL
      ...
      ,[CAD_Response_Primary_Role_Of_Unit]
      ,[CAD_Response_Mode_To_Scene]
    ...
    --   ,[CAD_Crew_Member_Respose_Role_List] -- TYPO  -- appears to all be NULL
      ...
      ,[CAD_Patient_Care_Report_Number_PCR] -- appears to all be NULL

      -- TIMES
      ,[CAD_Dispatch_Notified_Date_Time]
      ,[CAD_PSAP_Call_Date_Time]
      ,[CAD_Initial_Responder_Arrived_On_Scene_Date_Time]
      ...
      ,[CAD_Arrived_At_Patient_Date_Time]
      ...
      ,[CAD_Response_Narrative]
      ,[CAD_Response_Vehicle_Type]
      ,[CAD_Response_Vehicle_Dispatch_Location]
    ...
    --   ,[CAD_Incident_Dispatched_Hospital_Name]
      ...
      ,[CAD_Scene_Incident_Zone_Number]
      ...
      ,[CAD_Scene_Incident_Street_Address2]
