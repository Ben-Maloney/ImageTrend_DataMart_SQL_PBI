SELECT TOP (100) [Fact_Incident_PK]
      ...
      ,[CAD_Incident_ID1_Internal] -- no explicit join in datamart_ems.sql
    ...
    -- IGNORE THESE FOR NOW...
      ...
      -- ,[Disposition_Number_Of_Patients_Transported_In_EMS_Unit]  -- WE'RE A NON-TRANSPORT AGENCY.. SO IGNORE
...
ORDER BY Fact_Incident_PK DESC